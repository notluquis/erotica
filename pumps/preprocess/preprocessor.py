"""High-level utilities for preprocessing PUMPS catalogues."""
...
class DataPreprocessor:
    """Wrap preprocessing steps commonly applied to PUMPS-ready tables."""
    ...
    def rename_columns(self, mapping: dict[str, str] | None = None) -> list[str]:
        """Rename photometric columns following the canonical PUMPS schema."""
