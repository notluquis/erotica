"""Helper functions for PUMPS data preprocessing."""
...
from pumps.io._helpers import fill_masked_columns
...
def fill_missing_values(table: QTable) -> int:
    ...
    Delegates to :func:`pumps.io._helpers.fill_masked_columns` (identifier
