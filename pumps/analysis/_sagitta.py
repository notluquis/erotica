"""Sagitta integration helpers for PUMPS cluster analysis."""
...
def _ensure_sagitta() -> None:
    ...
    not on PyPI, so PUMPS never installs it automatically (silently shelling out
    ...
    if importlib.util.find_spec("sagitta") is None:
        raise ImportError(
            ...
            "installed. PUMPS does not install it automatically. Install it with:\n"
