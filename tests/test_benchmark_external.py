"""Tests for the COSMIC-vs-ASteCA-vs-pyUPMASK benchmark harness.
...
from cosmic.analysis.external.benchmark import (
    AgreementMetrics,
    BenchmarkReport,
    CalibrationMetrics,
    build_report,
...
def test_build_report_end_to_end(synthetic):
    ...
    report = build_report(
        "synthetic_cluster",
        {"COSMIC": cosmic, "ASteCA": asteca, "pyUPMASK": pyupmask},
        truth_membership=truth,
        truth_params={"loga": 7.0, "dm": 10.3},
        recovered_params={
            "COSMIC": {"loga": 7.02, "dm": 10.28},
            "ASteCA": {"loga": 6.95, "dm": 10.35},
        },
        param_uncertainties={"COSMIC": {"loga": 0.1, "dm": 0.1}},
        runtimes={"COSMIC": 12.5, "ASteCA": 40.0, "pyUPMASK": 88.0},
